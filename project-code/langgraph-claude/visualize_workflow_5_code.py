...
def plot_sentiment(ax, steps, symbol):
    ...
    if not sentiments:
        ...
        ax.text(0.5, 0.5, "⚠️ No sentiment data found.", ha="center", va="center")
        return
...
def plot_recommendations(ax, steps, symbol):
    ...
    if not recs:
        ...
        ax.text(0.5, 0.5, "⚠️ No recommendation data found.", ha="center", va="center")
        return
...
def plot_news_wordcloud(ax, steps, symbol):
    ...
    if not headlines:
        ...
        ax.text(0.5, 0.5, "⚠️ No news data found.", ha="center", va="center")
        return
